...
class PlayouthistoryController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->headScript()->appendFile('js/airtime/playouthistory/jquery-3.5.1.js','text/javascript');
        ...
        $this->view->headScript()->appendFile('js/datatables/plugin/jszip.js','text/javascript');
        $this->view->headScript()->appendFile('js/datatables/plugin/pdfmake.js','text/javascript');
        $this->view->headScript()->appendFile('js/datatables/plugin/pdfmake.vsfonts.js','text/javascript');
