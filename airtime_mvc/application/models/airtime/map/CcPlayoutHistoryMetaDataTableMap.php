...
class CcPlayoutHistoryMetaDataTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Airtime\\PlayoutHistory\\CcPlayoutHistoryMetaData');
    ...
    {
        $this->addRelation('CcPlayoutHistory', 'Airtime\\PlayoutHistory\\CcPlayoutHistory', RelationMap::MANY_TO_ONE, array('history_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
