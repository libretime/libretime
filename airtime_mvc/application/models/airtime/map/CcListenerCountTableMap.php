...
class CcListenerCountTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Airtime\\CcListenerCount');
    ...
    {
        $this->addRelation('CcTimestamp', 'Airtime\\CcTimestamp', RelationMap::MANY_TO_ONE, array('timestamp_id' => 'id', ), 'CASCADE', null);
        $this->addRelation('CcMountName', 'Airtime\\CcMountName', RelationMap::MANY_TO_ONE, array('mount_name_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
