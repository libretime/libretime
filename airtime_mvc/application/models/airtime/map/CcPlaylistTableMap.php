...
class CcPlaylistTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Airtime\\CcPlaylist');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CcPlaylistcontents', 'Airtime\\CcPlaylistcontents', RelationMap::ONE_TO_MANY, array('id' => 'playlist_id', ), 'CASCADE', null, 'CcPlaylistcontentss');
    } // buildRelations()
