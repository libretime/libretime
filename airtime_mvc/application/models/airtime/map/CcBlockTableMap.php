...
class CcBlockTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Airtime\\CcBlock');
    ...
    {
        $this->addRelation('CcSubjs', 'Airtime\\CcSubjs', RelationMap::MANY_TO_ONE, array('creator_id' => 'id', ), 'CASCADE', null);
        $this->addRelation('CcPlaylistcontents', 'Airtime\\CcPlaylistcontents', RelationMap::ONE_TO_MANY, array('id' => 'block_id', ), 'CASCADE', null, 'CcPlaylistcontentss');
        $this->addRelation('CcBlockcontents', 'Airtime\\CcBlockcontents', RelationMap::ONE_TO_MANY, array('id' => 'block_id', ), 'CASCADE', null, 'CcBlockcontentss');
        $this->addRelation('CcBlockcriteria', 'Airtime\\CcBlockcriteria', RelationMap::ONE_TO_MANY, array('id' => 'block_id', ), 'CASCADE', null, 'CcBlockcriterias');
    } // buildRelations()
