...
class CcFilesTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Airtime\\CcFiles');
    ...
    {
        $this->addRelation('FkOwner', 'Airtime\\CcSubjs', RelationMap::MANY_TO_ONE, array('owner_id' => 'id', ), null, null);
        $this->addRelation('CcSubjsRelatedByDbEditedby', 'Airtime\\CcSubjs', RelationMap::MANY_TO_ONE, array('editedby' => 'id', ), null, null);
        $this->addRelation('CcMusicDirs', 'Airtime\\CcMusicDirs', RelationMap::MANY_TO_ONE, array('directory' => 'id', ), null, null);
        $this->addRelation('CcShowInstances', 'Airtime\\CcShowInstances', RelationMap::ONE_TO_MANY, array('id' => 'file_id', ), 'CASCADE', null, 'CcShowInstancess');
        $this->addRelation('CcPlaylistcontents', 'Airtime\\CcPlaylistcontents', RelationMap::ONE_TO_MANY, array('id' => 'file_id', ), 'CASCADE', null, 'CcPlaylistcontentss');
        $this->addRelation('CcBlockcontents', 'Airtime\\CcBlockcontents', RelationMap::ONE_TO_MANY, array('id' => 'file_id', ), 'CASCADE', null, 'CcBlockcontentss');
        $this->addRelation('CcSchedule', 'Airtime\\CcSchedule', RelationMap::ONE_TO_MANY, array('id' => 'file_id', ), 'CASCADE', null, 'CcSchedules');
        $this->addRelation('CcPlayoutHistory', 'Airtime\\PlayoutHistory\\CcPlayoutHistory', RelationMap::ONE_TO_MANY, array('id' => 'file_id', ), 'CASCADE', null, 'CcPlayoutHistorys');
    } // buildRelations()
