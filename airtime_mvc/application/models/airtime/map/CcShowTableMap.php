...
class CcShowTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Airtime\\CcShow');
    ...
    {
        $this->addRelation('CcShowInstances', 'Airtime\\CcShowInstances', RelationMap::ONE_TO_MANY, array('id' => 'show_id', ), 'CASCADE', null, 'CcShowInstancess');
        $this->addRelation('CcShowDays', 'Airtime\\CcShowDays', RelationMap::ONE_TO_MANY, array('id' => 'show_id', ), 'CASCADE', null, 'CcShowDayss');
        $this->addRelation('CcShowRebroadcast', 'Airtime\\CcShowRebroadcast', RelationMap::ONE_TO_MANY, array('id' => 'show_id', ), 'CASCADE', null, 'CcShowRebroadcasts');
        $this->addRelation('CcShowHosts', 'Airtime\\CcShowHosts', RelationMap::ONE_TO_MANY, array('id' => 'show_id', ), 'CASCADE', null, 'CcShowHostss');
    } // buildRelations()
