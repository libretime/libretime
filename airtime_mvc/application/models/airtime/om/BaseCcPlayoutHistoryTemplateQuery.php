...
abstract class BaseCcPlayoutHistoryTemplateQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Airtime\\PlayoutHistory\\CcPlayoutHistoryTemplate';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Airtime\PlayoutHistory\CcPlayoutHistoryTemplateFieldQuery A secondary query class using the current class as primary query
     */
    public function useCcPlayoutHistoryTemplateFieldQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CcPlayoutHistoryTemplateField', '\Airtime\PlayoutHistory\CcPlayoutHistoryTemplateFieldQuery');
    }
