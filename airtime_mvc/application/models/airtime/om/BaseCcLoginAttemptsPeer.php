...
use \PropelException;
use \PropelPDO;
use Airtime\CcLoginAttempts;
use Airtime\CcLoginAttemptsPeer;
use Airtime\map\CcLoginAttemptsTableMap;
...
abstract class BaseCcLoginAttemptsPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcLoginAttempts';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcLoginAttemptsTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcLoginAttemptsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcLoginAttemptsTableMap());
      }
    }
