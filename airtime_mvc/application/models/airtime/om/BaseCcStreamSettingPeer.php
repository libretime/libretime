...
use \PropelException;
use \PropelPDO;
use Airtime\CcStreamSetting;
use Airtime\CcStreamSettingPeer;
use Airtime\map\CcStreamSettingTableMap;
...
abstract class BaseCcStreamSettingPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcStreamSetting';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcStreamSettingTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcStreamSettingPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcStreamSettingTableMap());
      }
    }
