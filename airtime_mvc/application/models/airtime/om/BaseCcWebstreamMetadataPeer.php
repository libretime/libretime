...
use Airtime\map\CcWebstreamMetadataTableMap;
...
abstract class BaseCcWebstreamMetadataPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcWebstreamMetadata';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcWebstreamMetadataTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcWebstreamMetadataPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcWebstreamMetadataTableMap());
      }
    }
