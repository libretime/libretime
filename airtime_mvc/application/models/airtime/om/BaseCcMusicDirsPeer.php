...
use Airtime\map\CcMusicDirsTableMap;
...
abstract class BaseCcMusicDirsPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcMusicDirs';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcMusicDirsTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcMusicDirsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcMusicDirsTableMap());
      }
    }
