...
use Airtime\PlayoutHistory\map\CcPlayoutHistoryTemplateTableMap;
...
abstract class BaseCcPlayoutHistoryTemplatePeer
{
    ...
    const OM_CLASS = 'Airtime\\PlayoutHistory\\CcPlayoutHistoryTemplate';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\PlayoutHistory\\map\\CcPlayoutHistoryTemplateTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcPlayoutHistoryTemplatePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\PlayoutHistory\map\CcPlayoutHistoryTemplateTableMap());
      }
    }
