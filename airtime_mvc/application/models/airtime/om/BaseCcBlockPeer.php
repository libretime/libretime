...
use Airtime\map\CcBlockTableMap;
...
abstract class BaseCcBlockPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcBlock';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcBlockTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcBlockPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcBlockTableMap());
      }
    }
