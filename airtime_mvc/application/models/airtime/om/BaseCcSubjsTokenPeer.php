...
use Airtime\CcSubjsTokenPeer;
use Airtime\map\CcSubjsTokenTableMap;
...
abstract class BaseCcSubjsTokenPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcSubjsToken';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcSubjsTokenTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcSubjsTokenPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcSubjsTokenTableMap());
      }
    }
