...
use Airtime\map\CcWebstreamTableMap;
...
abstract class BaseCcWebstreamPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcWebstream';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcWebstreamTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcWebstreamPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcWebstreamTableMap());
      }
    }
