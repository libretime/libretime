...
use Airtime\map\CcPlaylistcontentsTableMap;
...
abstract class BaseCcPlaylistcontentsPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcPlaylistcontents';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcPlaylistcontentsTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcPlaylistcontentsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcPlaylistcontentsTableMap());
      }
    }
