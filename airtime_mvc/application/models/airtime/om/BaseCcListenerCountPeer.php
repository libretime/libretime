...
use Airtime\map\CcListenerCountTableMap;
...
abstract class BaseCcListenerCountPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcListenerCount';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcListenerCountTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcListenerCountPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcListenerCountTableMap());
      }
    }
