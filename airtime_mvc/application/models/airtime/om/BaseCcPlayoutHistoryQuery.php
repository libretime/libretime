...
abstract class BaseCcPlayoutHistoryQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Airtime\\PlayoutHistory\\CcPlayoutHistory';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Airtime\PlayoutHistory\CcPlayoutHistoryMetaDataQuery A secondary query class using the current class as primary query
     */
    public function useCcPlayoutHistoryMetaDataQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CcPlayoutHistoryMetaData', '\Airtime\PlayoutHistory\CcPlayoutHistoryMetaDataQuery');
    }
