...
use Airtime\map\CcMountNameTableMap;
...
abstract class BaseCcMountNamePeer
{
    ...
    const OM_CLASS = 'Airtime\\CcMountName';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcMountNameTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcMountNamePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcMountNameTableMap());
      }
    }
