 ...
 */
abstract class BaseMediaContents extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Airtime\\MediaItem\\MediaContentsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        MediaContentsPeer
     */
    ...
    /**
     * Initializes internal state of BaseMediaContents object.
     * @see        applyDefaults()
     */
     ...
     * @return MediaContents The current object (for fluent API support)
     */
    public function setDbId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = MediaContentsPeer::ID;
        }
    ...
    public function setMediaId($v)
    {
        ...
        if ($this->media_id !== $v) {
            $this->media_id = $v;
            $this->modifiedColumns[] = MediaContentsPeer::MEDIA_ID;
        }
    ...
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[] = MediaContentsPeer::POSITION;
        }
    ...
    public function setTrackOffset($v)
    {
        ...
        if ($this->trackoffset !== $v) {
            $this->trackoffset = $v;
            $this->modifiedColumns[] = MediaContentsPeer::TRACKOFFSET;
        }
    ...
    public function setCliplength($v)
    {
        ...
        if ($this->cliplength !== $v) {
            $this->cliplength = $v;
            $this->modifiedColumns[] = MediaContentsPeer::CLIPLENGTH;
        }
    ...
    public function setCuein($v)
    {
        ...
        if ($this->cuein !== $v) {
            $this->cuein = $v;
            $this->modifiedColumns[] = MediaContentsPeer::CUEIN;
        }
    ...
    public function setCueout($v)
    {
        ...
        if ($this->cueout !== $v) {
            $this->cueout = $v;
            $this->modifiedColumns[] = MediaContentsPeer::CUEOUT;
        }
    ...
    public function setFadein($v)
    {
        ...
        if ($this->fadein !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = MediaContentsPeer::FADEIN;
            }
    ...
    public function setFadeout($v)
    {
        ...
        if ($this->fadeout !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = MediaContentsPeer::FADEOUT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = MediaContentsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating MediaContents object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MediaContentsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MediaContentsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MediaContentsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MediaContentsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(MediaContentsPeer::MEDIA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"media_id"';
        }
        if ($this->isColumnModified(MediaContentsPeer::POSITION)) {
            $modifiedColumns[':p' . $index++]  = '"position"';
        }
        if ($this->isColumnModified(MediaContentsPeer::TRACKOFFSET)) {
            $modifiedColumns[':p' . $index++]  = '"trackoffset"';
        }
        if ($this->isColumnModified(MediaContentsPeer::CLIPLENGTH)) {
            $modifiedColumns[':p' . $index++]  = '"cliplength"';
        }
        if ($this->isColumnModified(MediaContentsPeer::CUEIN)) {
            $modifiedColumns[':p' . $index++]  = '"cuein"';
        }
        if ($this->isColumnModified(MediaContentsPeer::CUEOUT)) {
            $modifiedColumns[':p' . $index++]  = '"cueout"';
        }
        if ($this->isColumnModified(MediaContentsPeer::FADEIN)) {
            $modifiedColumns[':p' . $index++]  = '"fadein"';
        }
        if ($this->isColumnModified(MediaContentsPeer::FADEOUT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MediaContentsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MediaContentsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MediaContents'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MediaContents'][$this->getPrimaryKey()] = true;
        $keys = MediaContentsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getDbId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MediaContentsPeer::ID)) $criteria->add(MediaContentsPeer::ID, $this->id);
        if ($this->isColumnModified(MediaContentsPeer::MEDIA_ID)) $criteria->add(MediaContentsPeer::MEDIA_ID, $this->media_id);
        if ($this->isColumnModified(MediaContentsPeer::POSITION)) $criteria->add(MediaContentsPeer::POSITION, $this->position);
        if ($this->isColumnModified(MediaContentsPeer::TRACKOFFSET)) $criteria->add(MediaContentsPeer::TRACKOFFSET, $this->trackoffset);
        if ($this->isColumnModified(MediaContentsPeer::CLIPLENGTH)) $criteria->add(MediaContentsPeer::CLIPLENGTH, $this->cliplength);
        if ($this->isColumnModified(MediaContentsPeer::CUEIN)) $criteria->add(MediaContentsPeer::CUEIN, $this->cuein);
        if ($this->isColumnModified(MediaContentsPeer::CUEOUT)) $criteria->add(MediaContentsPeer::CUEOUT, $this->cueout);
        if ($this->isColumnModified(MediaContentsPeer::FADEIN)) $criteria->add(MediaContentsPeer::FADEIN, $this->fadein);
        if ($this->isColumnModified(MediaContentsPeer::FADEOUT)) $criteria->add(MediaContentsPeer::FADEOUT, $this->fadeout);
    ...
    {
        $criteria = new Criteria(MediaContentsPeer::DATABASE_NAME);
        $criteria->add(MediaContentsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of MediaContents (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return MediaContents Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return MediaContentsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new MediaContentsPeer();
        }
    ...
    public function getMediaItem(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMediaItem === null && ($this->media_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMediaItem->addMediaContentss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MediaContentsPeer::DEFAULT_STRING_FORMAT);
    }
