...
use Airtime\map\CcFilesTableMap;
...
abstract class BaseCcFilesPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcFiles';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcFilesTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcFilesPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcFilesTableMap());
      }
    }
