...
use Airtime\map\CcTimestampTableMap;
...
abstract class BaseCcTimestampPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcTimestamp';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcTimestampTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcTimestampPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcTimestampTableMap());
      }
    }
