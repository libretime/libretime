 ...
 */
abstract class BaseBlockPeer extends PlaylistPeer
{
    ...
    const TM_CLASS = 'Airtime\\MediaItem\\map\\BlockTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (BlockPeer::TYPE, BlockPeer::ID, BlockPeer::NAME, BlockPeer::OWNER_ID, BlockPeer::DESCRIPTION, BlockPeer::LAST_PLAYED, BlockPeer::PLAY_COUNT, BlockPeer::LENGTH, BlockPeer::CREATED_AT, BlockPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (BlockPeer::TYPE => 0, BlockPeer::ID => 1, BlockPeer::NAME => 2, BlockPeer::OWNER_ID => 3, BlockPeer::DESCRIPTION => 4, BlockPeer::LAST_PLAYED => 5, BlockPeer::PLAY_COUNT => 6, BlockPeer::LENGTH => 7, BlockPeer::CREATED_AT => 8, BlockPeer::UPDATED_AT => 9, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BlockPeer::OWNER_ID);
            $criteria->addSelectColumn(BlockPeer::DESCRIPTION);
            $criteria->addSelectColumn(BlockPeer::LAST_PLAYED);
            $criteria->addSelectColumn(BlockPeer::PLAY_COUNT);
            $criteria->addSelectColumn(BlockPeer::LENGTH);
    ...
    public static function doCountJoinPlaylist(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BlockPeer::ID, PlaylistPeer::ID, $join_behavior);
    ...
    public static function doCountJoinMediaItem(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BlockPeer::ID, MediaItemPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCcSubjs(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BlockPeer::OWNER_ID, CcSubjsPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Block objects pre-filled with their Playlist objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinPlaylist(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Block) to $obj2 (Playlist)
                // one to one relationship
                $obj1->setPlaylist($obj2);
    ...
    /**
     * Selects a collection of Block objects pre-filled with their MediaItem objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Block objects.
    ...
    public static function doSelectJoinMediaItem(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Block) to $obj2 (MediaItem)
                // one to one relationship
    ...
    /**
     * Selects a collection of Block objects pre-filled with their CcSubjs objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Block objects.
    ...
    public static function doSelectJoinCcSubjs(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Block) to $obj2 (CcSubjs)
                $obj2->addBlock($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Block) to the collection in $obj2 (Playlist)
                $obj1->setPlaylist($obj2);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Block) to the collection in $obj3 (MediaItem)
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Block) to the collection in $obj4 (CcSubjs)
                $obj4->addBlock($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Block objects pre-filled with all related objects except Playlist.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptPlaylist(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = BlockPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Block) to the collection in $obj2 (MediaItem)
                $obj1->setMediaItem($obj2);
                ...
                // Add the $obj1 (Block) to the collection in $obj3 (CcSubjs)
                $obj3->addBlock($obj1);
    ...
    /**
     * Selects a collection of Block objects pre-filled with all related objects except MediaItem.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Block objects pre-filled with all related objects except CcSubjs.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBlockPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\MediaItem\map\BlockTableMap());
      }
    }
