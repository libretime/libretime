...
abstract class BaseCcBlockQuery extends ModelCriteria
{
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Airtime\CcBlockcriteriaQuery A secondary query class using the current class as primary query
     */
    public function useCcBlockcriteriaQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CcBlockcriteria', '\Airtime\CcBlockcriteriaQuery');
    }
