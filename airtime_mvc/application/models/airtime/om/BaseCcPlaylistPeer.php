...
use Airtime\map\CcPlaylistTableMap;
...
abstract class BaseCcPlaylistPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcPlaylist';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcPlaylistTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcPlaylistPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcPlaylistTableMap());
      }
    }
