 ...
 */
abstract class BaseBlock extends Playlist implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Airtime\\MediaItem\\BlockPeer';
    ...
    public function setOwnerId($v)
    {
        ...
        if ($this->owner_id !== $v) {
            $this->owner_id = $v;
            $this->modifiedColumns[] = BlockPeer::OWNER_ID;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = BlockPeer::DESCRIPTION;
        }
    ...
    public function setLastPlayedTime($v)
    {
        ...
        if ($this->last_played !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BlockPeer::LAST_PLAYED;
            }
    ...
    public function setPlayCount($v)
    {
        ...
        if ($this->play_count !== $v) {
            $this->play_count = $v;
            $this->modifiedColumns[] = BlockPeer::PLAY_COUNT;
        }
    ...
    public function setLength($v)
    {
        ...
        if ($this->length !== $v) {
            $this->length = $v;
            $this->modifiedColumns[] = BlockPeer::LENGTH;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = BlockPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BlockPeer::OWNER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"owner_id"';
        }
        if ($this->isColumnModified(BlockPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '"description"';
        }
        if ($this->isColumnModified(BlockPeer::LAST_PLAYED)) {
            $modifiedColumns[':p' . $index++]  = '"last_played"';
        }
        if ($this->isColumnModified(BlockPeer::PLAY_COUNT)) {
            $modifiedColumns[':p' . $index++]  = '"play_count"';
        }
        if ($this->isColumnModified(BlockPeer::LENGTH)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BlockPeer::OWNER_ID)) $criteria->add(BlockPeer::OWNER_ID, $this->owner_id);
        if ($this->isColumnModified(BlockPeer::DESCRIPTION)) $criteria->add(BlockPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(BlockPeer::LAST_PLAYED)) $criteria->add(BlockPeer::LAST_PLAYED, $this->last_played);
        if ($this->isColumnModified(BlockPeer::PLAY_COUNT)) $criteria->add(BlockPeer::PLAY_COUNT, $this->play_count);
        if ($this->isColumnModified(BlockPeer::LENGTH)) $criteria->add(BlockPeer::LENGTH, $this->length);
    ...
    {
        if ($this->aPlaylist === null && ($this->id !== null) && $doQuery) {
            $this->aPlaylist = PlaylistQuery::create()->findPk($this->id, $con);
            // Because this foreign key represents a one-to-one relationship, we will create a bi-directional association.
            $this->aPlaylist->setBlock($this);
        }
    ...
    /**
     * Get or Create the parent Playlist object of the current object
     *
     * @return    Playlist The parent object
     */
    public function getParentOrCreate($con = null)
    {
        if ($this->isNew()) {
            if ($this->isPrimaryKeyNull()) {
                ...
                if (null === ($parent = $this->getPlaylist($con))) {
                    $parent = new Playlist();
                }
                $parent->setDescendantClass('Airtime\MediaItem\Block');

                return $parent;
            } else {
                $parent = PlaylistQuery::create()->findPk($this->getPrimaryKey(), $con);
        ...
        return PlaylistQuery::create()->findPk($this->getPrimaryKey(), $con);
    }

    /**
     * Create or Update the parent Playlist object
