...
use Airtime\CcShowRebroadcastPeer;
use Airtime\map\CcShowRebroadcastTableMap;
...
abstract class BaseCcShowRebroadcastPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcShowRebroadcast';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcShowRebroadcastTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcShowRebroadcastPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcShowRebroadcastTableMap());
      }
    }
