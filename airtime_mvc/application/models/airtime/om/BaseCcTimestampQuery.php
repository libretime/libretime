...
use Airtime\CcTimestampPeer;
use Airtime\CcTimestampQuery;
...
abstract class BaseCcTimestampQuery extends ModelCriteria
{
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Airtime\CcListenerCountQuery A secondary query class using the current class as primary query
     */
    public function useCcListenerCountQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CcListenerCount', '\Airtime\CcListenerCountQuery');
    }
