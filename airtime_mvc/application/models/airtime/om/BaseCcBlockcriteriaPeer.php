...
use Airtime\map\CcBlockcriteriaTableMap;
...
abstract class BaseCcBlockcriteriaPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcBlockcriteria';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcBlockcriteriaTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcBlockcriteriaPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcBlockcriteriaTableMap());
      }
    }
