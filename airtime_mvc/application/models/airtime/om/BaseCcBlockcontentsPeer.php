...
use Airtime\map\CcBlockcontentsTableMap;
...
abstract class BaseCcBlockcontentsPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcBlockcontents';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcBlockcontentsTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcBlockcontentsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcBlockcontentsTableMap());
      }
    }
