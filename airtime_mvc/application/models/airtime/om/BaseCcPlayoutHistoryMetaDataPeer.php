...
use Airtime\PlayoutHistory\map\CcPlayoutHistoryMetaDataTableMap;
...
abstract class BaseCcPlayoutHistoryMetaDataPeer
{
    ...
    const OM_CLASS = 'Airtime\\PlayoutHistory\\CcPlayoutHistoryMetaData';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\PlayoutHistory\\map\\CcPlayoutHistoryMetaDataTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcPlayoutHistoryMetaDataPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\PlayoutHistory\map\CcPlayoutHistoryMetaDataTableMap());
      }
    }
