...
use Airtime\PlayoutHistory\map\CcPlayoutHistoryTemplateFieldTableMap;
...
abstract class BaseCcPlayoutHistoryTemplateFieldPeer
{
    ...
    const OM_CLASS = 'Airtime\\PlayoutHistory\\CcPlayoutHistoryTemplateField';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\PlayoutHistory\\map\\CcPlayoutHistoryTemplateFieldTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcPlayoutHistoryTemplateFieldPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\PlayoutHistory\map\CcPlayoutHistoryTemplateFieldTableMap());
      }
    }
