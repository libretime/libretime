...
use Airtime\map\CcSubjsTableMap;
...
abstract class BaseCcSubjsPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcSubjs';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcSubjsTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcSubjsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcSubjsTableMap());
      }
    }
