...
use \PropelException;
use \PropelPDO;
use Airtime\CcLiveLog;
use Airtime\CcLiveLogPeer;
use Airtime\map\CcLiveLogTableMap;
...
abstract class BaseCcLiveLogPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcLiveLog';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcLiveLogTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcLiveLogPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcLiveLogTableMap());
      }
    }
