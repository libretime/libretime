...
use Airtime\map\CcShowTableMap;
...
abstract class BaseCcShowPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcShow';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcShowTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcShowPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcShowTableMap());
      }
    }
