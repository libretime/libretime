...
use \PropelPDO;
use Airtime\CcListenerCount;
use Airtime\CcListenerCountPeer;
use Airtime\CcListenerCountQuery;
use Airtime\CcMountName;
use Airtime\CcTimestamp;
...
abstract class BaseCcListenerCountQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Airtime\\CcListenerCount';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Airtime\CcTimestampQuery A secondary query class using the current class as primary query
     */
    public function useCcTimestampQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CcTimestamp', '\Airtime\CcTimestampQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Airtime\CcMountNameQuery A secondary query class using the current class as primary query
     */
    public function useCcMountNameQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CcMountName', '\Airtime\CcMountNameQuery');
    }
