...
use Airtime\map\CcShowDaysTableMap;
...
abstract class BaseCcShowDaysPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcShowDays';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcShowDaysTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcShowDaysPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcShowDaysTableMap());
      }
    }
