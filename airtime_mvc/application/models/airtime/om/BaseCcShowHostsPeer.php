...
use Airtime\map\CcShowHostsTableMap;
...
abstract class BaseCcShowHostsPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcShowHosts';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcShowHostsTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcShowHostsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcShowHostsTableMap());
      }
    }
