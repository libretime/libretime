...
use Airtime\CcServiceRegisterPeer;
use Airtime\map\CcServiceRegisterTableMap;
...
abstract class BaseCcServiceRegisterPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcServiceRegister';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcServiceRegisterTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcServiceRegisterPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcServiceRegisterTableMap());
      }
    }
