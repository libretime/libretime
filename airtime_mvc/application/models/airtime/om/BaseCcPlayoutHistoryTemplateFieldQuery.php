...
namespace Airtime\PlayoutHistory\om;
...
use Airtime\PlayoutHistory\CcPlayoutHistoryTemplateFieldQuery;
...
abstract class BaseCcPlayoutHistoryTemplateFieldQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Airtime\\PlayoutHistory\\CcPlayoutHistoryTemplateField';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Airtime\PlayoutHistory\CcPlayoutHistoryTemplateQuery A secondary query class using the current class as primary query
     */
    public function useCcPlayoutHistoryTemplateQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CcPlayoutHistoryTemplate', '\Airtime\PlayoutHistory\CcPlayoutHistoryTemplateQuery');
    }
