...
use Airtime\PlayoutHistory\map\CcPlayoutHistoryTableMap;
...
abstract class BaseCcPlayoutHistoryPeer
{
    ...
    const OM_CLASS = 'Airtime\\PlayoutHistory\\CcPlayoutHistory';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\PlayoutHistory\\map\\CcPlayoutHistoryTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcPlayoutHistoryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\PlayoutHistory\map\CcPlayoutHistoryTableMap());
      }
    }
