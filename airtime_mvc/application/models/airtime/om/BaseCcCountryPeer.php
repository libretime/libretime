...
use \PropelException;
use \PropelPDO;
use Airtime\CcCountry;
use Airtime\CcCountryPeer;
use Airtime\map\CcCountryTableMap;
...
abstract class BaseCcCountryPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcCountry';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcCountryTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcCountryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcCountryTableMap());
      }
    }
