...
use \PropelException;
use \PropelPDO;
use Airtime\CcLocale;
use Airtime\CcLocalePeer;
use Airtime\map\CcLocaleTableMap;
...
abstract class BaseCcLocalePeer
{
    ...
    const OM_CLASS = 'Airtime\\CcLocale';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcLocaleTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcLocalePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcLocaleTableMap());
      }
    }
