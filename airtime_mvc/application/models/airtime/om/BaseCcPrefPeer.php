...
use Airtime\map\CcPrefTableMap;
...
abstract class BaseCcPrefPeer
{
    ...
    const OM_CLASS = 'Airtime\\CcPref';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Airtime\\map\\CcPrefTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCcPrefPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Airtime\map\CcPrefTableMap());
      }
    }
