...
class Application_Model_ShowBuilder
{
    ...
    private function makeHeaderRow($p_item)
    {
        ...
        if($p_item['show_name']) $row['title'] = htmlspecialchars($p_item['show_name']);
    ...
    private function makeScheduledItemRow($p_item)
    {
        ...
        if (isset($p_item['sched_starts'])) {
            ...
            if($p_item['file_track_title']) $row['title'] = htmlspecialchars($p_item['file_track_title']);
            if($p_item['file_artist_name']) $row['creator'] = htmlspecialchars($p_item['file_artist_name']);
            if($p_item['file_album_title']) $row['album'] = htmlspecialchars($p_item['file_album_title']);
