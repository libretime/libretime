...
/**
 * Base class that represents a row from the 'cloud_file' table.
 *
 *
 *
 * @package    propel.generator.airtime.om
 */
abstract class BaseCloudFile extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CloudFilePeer';
    ...
    /**
     * The value for the cc_file_id field.
     * @var        int
     */
    protected $cc_file_id;
    ...
    /**
     * Get the [cc_file_id] column value.
     *
     * @return int
     */
    ...
    public function setDbId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CloudFilePeer::ID;
        }
    ...
    public function setResourceId($v)
    {
        ...
        if ($this->resource_id !== $v) {
            $this->resource_id = $v;
            $this->modifiedColumns[] = CloudFilePeer::RESOURCE_ID;
        }
    ...
    /**
     * Set the value of [cc_file_id] column.
     *
     * @param  int $v new value
     * @return CloudFile The current object (for fluent API support)
     */
    public function setCcFileId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->cc_file_id !== $v) {
            $this->cc_file_id = $v;
            $this->modifiedColumns[] = CloudFilePeer::CC_FILE_ID;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCcFiles !== null && $this->cc_file_id !== $this->aCcFiles->getDbId()) {
            $this->aCcFiles = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CloudFilePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CloudFileQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CloudFilePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('cloud_file_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(CloudFilePeer::CC_FILE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"cc_file_id"';
        }

        $sql = sprintf(
            'INSERT INTO "cloud_file" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"resource_id"':
                        ...
                        break;
                    case '"cc_file_id"':
                        $stmt->bindValue($identifier, $this->cc_file_id, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CloudFilePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CloudFilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CloudFile'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
    ...
    {
        $criteria = new Criteria(CloudFilePeer::DATABASE_NAME);
        $criteria->add(CloudFilePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CloudFile (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CloudFile Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CloudFilePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CloudFilePeer();
        }
    ...
    {
        if ($v === null) {
            $this->setCcFileId(NULL);
        } else {
            $this->setCcFileId($v->getDbId());
        }
    ...
    {
        if ($this->aCcFiles === null && ($this->cc_file_id !== null) && $doQuery) {
            $this->aCcFiles = CcFilesQuery::create()->findPk($this->cc_file_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCcFiles->addCloudFiles($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CloudFilePeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        if (is_callable(array('CcFiles', $name))) {
            if (!$delegate = $this->getCcFiles()) {
                $delegate = new CcFiles();
                $this->setCcFiles($delegate);
            }
