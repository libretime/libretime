...
INSTALLED_APPS = [
    "libretime.api.apps.LibreTimeAPIConfig",
...
ROOT_URLCONF = "libretime.api.urls"
...
WSGI_APPLICATION = "libretime.api.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": [
        "libretime.api.permissions.IsSystemTokenOrUser",
    ],
