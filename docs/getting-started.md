...
![](../on-air-in-60-seconds/img/Screenshot559-Log_in.png)
...
![](img/Screenshot467-Reset_password_link.png) 

The **E-mail** address you enter must match the address stored in the database
for your **Username**.

![](img/Screenshot468-Restore_password.png)
...
![](img/Screenshot-MasterPanel.png)
...
![](img/Screenshot469-On_Air_light.png)
...
![](img/Screenshot470-User_settings.png)
...
![](img/Screenshot293-Icecast_status_page.png)
